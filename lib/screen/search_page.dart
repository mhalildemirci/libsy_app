...
class _ImageSearchState extends State<ImageSearch> {
  ...
  Map<String, List<String>> imageTags = {
    '2 Poems.jpg': ['2', 'Poems'],
    'the light.jpg': ['the', 'light'],
    'the idiot.jpg': ['the', 'idiot'],
    'the inferno.jpg': ['the', 'inferno'],
    'beyond good and evil.jpg': ['beyond', 'evil'],
    'The Master of the World.jpg': ['Master', 'World'],
    'ay pesinde.jpg': ['ay', 'pesinde', 'peşinde'],
    '11 Intentions.jpg': [
      'Intentions',
    ],
    'A Connecticut Yankee in King Arthurs Court.jpg': [
    ...
    'a modest proposal.jpg': ['modest', 'proposal'],
    'A Short History of the World.jpg': ['Short', 'History', 'World'],
    'a tale of two cities.jpg': ['tale', 'cities'],
    'A Tangled Tale.jpg': ['Tangled', 'Tale'],
    'a treatise of human nature.jpg': ['treatise', 'nature'],
    'a vital problem of married.jpg': ['vital', 'problem', 'married'],
    'a vısıt to three fonts.jpg': ['three', 'fonts'],
    'adventures in journalism.jpg': ['adventures', 'journalism'],
    'Adventures of Huckleberry Finn.jpg': ['adventures', 'Finn', 'Huckleberry'],
    'alemdagda bir yilan.jpg': ['alemdagda', 'yilan'],
    'Alices Adventures in Wonderland.jpg': [
      'Alices',
      'Adventures',
      'Wonderland'
    ],
    'An Elegy on the Glory of her Sex.jpg': ['Elegy', 'Glory', 'Sex'],
    'an enquiry concerning human understanding.jpg': [
      'enquiry',
      'understanding'
    ],
    ...
    'Ann Veronica.jpg': ['Ann', 'Veronica'],
    'Around the World in 80 Days.jpg': ['Around', 'World', '80'],
    'atesten gomlek.jpg': ['atesten', 'gomlek'],
    'balkan harbi.jpg': ['balkan', 'harbi'],
    'barnaby rudge.jpg': ['barnaby', 'rudge'],
    'Benjamin Franklin.jpg': ['Benjamin', 'Franklin'],
    'bes sehir.jpg': ['bes', 'sehir'],
    'bleak house.jpg': ['bleak', 'house'],
    'Boom, peace and quiet.jpg': ['Boom', 'quiet'],
    'bozkurtlar diriliyor.jpg': ['bozkurtlar', 'diriliyor'],
    'bozkurtlarin olumu.jpg': ['bozkurtlarin', 'olumu'],
    'bugunun saraylisi.jpg': ['bugunun', 'saraylisi'],
    'butun oykuler.jpg': ['butun', 'oykuler'],
    'cakicinin ilk kursunu.jpg': ['cakicinin', 'kursunu'],
    'candide.jpg': [
      'candide',
    ],
    'capitale de la douleur.jpg': ['capitale', 'douleur'],
    'classic for chilldren.jpg': ['classic', 'chilldren'],
    'cleopatra.jpg': ['cleopatra'],
    'Confidence.jpg': [
      'Confidence',
    ],
    'daniel deronda.jpg': ['daniel', 'deronda'],
    'david copperfield.jpg': ['david', 'copperfield'],
    'Death in Venice.jpg': ['Death', 'Venice'],
    'Der Zeuberberg.jpg': ['Der', 'Zeuberberg'],
    'dialogues concerning natural religion.jpg': [
      'dialogues',
      'natural',
      'religion'
    ],
    'dirilen iskelet.jpg': ['dirilen', 'iskelet'],
    'divine comedy.jpg': ['divine', 'comedy'],
    'dombey and son.jpg': ['dombey', 'son'],
    'don quixote.jpg': ['don', 'quixote'],
    'Dorothy amd the Wizard Oz.jpg': ['Dorothy', 'Wizard'],
    'dream psychology.jpg': ['dream', 'psychology'],
    'Edinburgh.jpg': ['Edinburgh'],
    'eight cousins.jpg': ['eight', 'cousins'],
    'fair margaret.jpg': ['fair', 'margaret'],
    'faust 1.jpg': ['faust', '1'],
    'faust 2.jpg': ['faust', '2'],
    'First and Last Things.jpg': ['First', 'Things'],
    'Fundamental Principles of the Metaphysic of Morals.jpg': [
      'Fundamental',
      'Metaphysic'
    ],
    'general-introduction-to-psychoanalysis.jpg': ['general', 'psychoanalysis'],
    'God the Invisible King.jpg': ['God', 'Invisible'],
    'great expectations.jpg': ['great', 'expectations'],
    'Gullivers travel.jpg': ['Gullivers', 'travel'],
    'hamlet.jpg': ['hamlet'],
    'hard times.jpg': ['hard', 'times'],
    'Hawthorne.jpg': ['Hawthorne'],
    'henry v.jpg': ['henry', 'v'],
    'homage to catalonia.jpg': ['homage', 'catalonia'],
    'hospital sketches.jpg': ['hospital', 'sketches'],
    'Human, All Too Human.jpg': ['Human', 'All'],
    'hunger.jpg': ['hunger'],
    'huzur.jpg': ['huzur'],
    'ibni batuta.jpg': ['ibni', 'batuta'],
    'icmizde ki seytan.jpg': ['icmizde', 'seytan'],
    'iffet.jpg': ['iffet'],
    'iliad.jpg': ['iliad'],
    'In the Days of the Comet.jpg': ['Comet', 'Days'],
    'in the penal colony.jpg': ['penal', 'colony'],
    'israel potter.jpg': ['israel', 'potter'],
    'istanbulun ic yuzu.jpg': ['istanbulun', 'yüzü'],
    'jack and jill.jpg': ['jack', 'jill'],
    'jos boys.jpg': ['jos', 'boys'],
    'julius-caesar.jpg': ['julius', 'caesar'],
    'kalp agrisi.jpg': ['kalp', 'ağrısı'],
    'kasagi.jpg': ['kaşağı'],
    'Kidnapped.jpg': ['Kidnapped'],
    'kinglear.jpg': ['king', 'lear'],
    'Life on the Mississippi.jpg': ['Life', 'Mississippi'],
    'macbeth.jpg': ['macbeth'],
    'MAHUR BESTE.jpg': ['mahur', 'beste'],
    'mansfield park.jpg': ['mansfield', 'park'],
    'markopasa ve yazilari.jpg': ['markopasa', 'yazilari'],
    'martin chuzzlewit.jpg': ['martin', 'chuzzlewit'],
    'medari maiset motoru.jpg': ['medari', 'maiset'],
    'memleket hikayeleri.jpg': ['memleket', 'hikayeleri'],
    'merchant-of-venice.jpg': ['merchant', 'venice'],
    'metres.jpg': ['metres'],
    'micromeas.jpg': ['micromeas'],
    'midsummernight.jpg': ['midsummernight'],
    'moby dick.jpg': ['moby', 'dick'],
    'moon of israel.jpg': ['moon', 'israel'],
    'Mr. Britling Sees It Through.jpg': ['Britling', 'Through'],
    'mrs  dalloway in bond street.jpg': ['dalloway', 'street'],
    'murebbiye.jpg': ['mürebbiye'],
    'nada the lily.jpg': ['nada', 'lily'],
    'natural selection.jpg': ['natural', 'selection'],
    'New Arabian.jpg': ['New', 'Arabian'],
    'new life.jpg': ['new', 'life'],
    'nicholas nickleby.jpg': ['nicholas', 'nickleby'],
    'Ninety Three.jpg': ['Ninety', 'Three'],
    'notes from the underground.jpg': ['notes', 'underground'],
    'Notes of a Son and Brother.jpg': ['Notes', 'Son'],
    'Notre Dame de Paris.jpg': ['Notre', 'Paris'],
    'now it can be told.jpg': ['now', 'told'],
    'oliver twist.jpg': ['oliver', 'twist'],
    'our mutual friend.jpg': ['mutual', 'friend'],
    'our with spain for cuba freedom.jpg': ['spain', 'freedom'],
    'oyle bir hikaye.jpg': ['öyle', 'hikaye'],
    'poems of william blake.jpg': ['poems', 'william'],
    'pride and prejudice.jpg': ['pride', 'prejudice'],
    'Prince Otto, a Romance.jpg': ['Prince', 'Romance'],
    'Protagoras.jpg': ['Protagoras', 'Platon'],
    'resurrection.jpg': ['resurrection'],
    'Rhyme and Reason.jpg': ['Rhyme', 'Reason'],
    'Roderick Hudson.jpg': ['Roderick', 'Hudson'],
    'romeo-and-juliet.jpg': ['romeo', 'juliet'],
    'romola.jpg': [
      'romola',
    ],
    'rose in bloom.jpg': ['rose', 'bloom'],
    'saatlerı ayarlama enstıtusu.jpg': ['saatleri', 'ayarlama'],
    'salommbo.jpg': ['salommbo'],
    'saray ve otesi.jpg': ['saray', 'ötesi'],
    'sehrın dısındakıler.jpg': ['şehrin', 'dışındakiler'],
    'semaver.jpg': [
      'semaver',
    ],
    'sense and sensibility.jpg': ['sense', 'sensibility'],
    'sevda sokagi komedyasi.jpg': ['sevda', 'sokağı'],
    'seyehatname.jpg': ['evliya', 'çelebi', 'seyehatname'],
    'she and allan.jpg': ['she', 'allan'],
    'silas marner.jpg': ['silas', 'marner'],
    'sinekkli bakkal.jpg': ['sinekkli', 'bakkal'],
    'sipsevdi.jpg': ['şıp', 'sevdi'],
    'songs of innocence.jpg': ['songs', 'innocence'],
    'St. Ives.jpg': ['St', 'Ives'],
    'Sylvie and Bruno.jpg': ['Sylvie', 'Bruno'],
    'tatarcik.jpg': ['tatarcık'],
    'tempest.jpg': ['tempest'],
    'The Adventures of Tom Sawyer.jpg': ['Adventures', 'Tom', 'Sawyer'],
    'The Ambassadors.jpg': ['The', 'Ambassadors'],
    'The Antichrist.jpg': ['Antichrist'],
    'the beautiful and damned.jpg': ['beautiful', 'damned'],
    'The Black Arrow. A Tale Of Two Roses.jpg': ['Black', 'Tale'],
    'the bostanians.jpg': ['bostanians'],
    'the brothers karamazoc.jpg': ['brothers', 'karamazoc'],
    'The Burning Secret.jpg': ['Burning', 'Secret'],
    'The Chartreuse of Parma.jpg': ['Chartreuse', 'Parma'],
    'the confidence.jpg': ['confidence'],
    'The Cossacks.jpg': ['Cossacks'],
    'the crime and punishment.jpg': ['crime', 'punishment'],
    'The Crime of the Congo.jpg': ['Crime', 'Congo'],
    'The Critique of Pure Reason.jpg': ['Critique', 'Reason'],
    'the desert village.jpg': ['desert', 'village'],
    'The Door in the Wall.jpg': ['Door', 'Wall'],
    'The Exemplary Novels of Cervantes.jpg': ['Exemplary', 'Cervantes'],
    'The First Men In The Moon.jpg': ['First', 'Moon'],
    'The Food of the Gods.jpg': ['Food', 'Gods'],
    'The Fur Country.jpg': ['Fur', 'Country'],
    'the gambler.jpg': ['gambler'],
    'the genealogy of morals.jpg': ['genealogy', 'morals'],
    'the gold bug.jpg': ['gold', 'bug'],
    'the golden bowl.jpg': ['golden', 'bowl'],
    'The great boer war.jpg': ['great', 'boer'],
    'the great gatsby.jpg': ['great', 'gatsby'],
    'the history of england i.jpg': ['history', 'england'],
    'the history of england ii.jpg': ['history', 'england'],
    'the history of england iii.jpg': ['history', 'england'],
    'the history of england iv.jpg': ['history', 'england'],
    'the history of england v.jpg': ['history', 'england'],
    'the history of england vi.jpg': ['history', 'england'],
    'The History Of Mr. Polly.jpg': ['History', 'Polly'],
    'The Hunting of the Snark.jpg': ['Hunting', 'Snark'],
    'The Innocents Abroad, travel.jpg': ['Innocents', 'Abroad'],
    'The Invisible Man.jpg': ['Invisible', 'Man'],
    'The Island of Dr. Moreau.jpg': ['Island', 'Moreau'],
    'the journal to stella.jpg': ['journal', 'stella'],
    'the king solomon.jpg': ['king', 'solomon'],
    'The Man in the Brown Suits.jpg': ['Man', 'Brown'],
    'the masque of the red death.jpg': ['masque', 'death'],
    'The Murder on the links.jpg': ['Murder', 'links'],
    'The Mysterious Island.jpg': ['Mysterious', 'Island'],
    'the mystery marie roget.jpg': ['mystery', 'marie'],
    'the mystery of edwin drood.jpg': ['mystery', 'edwin'],
    'the mystery of the blue train.jpg': ['mystery', 'blue', 'train'],
    'The New Machiavelli.jpg': ['New', 'Machiavelli'],
    'the portrait of dorian gray.jpg': ['portrait', 'dorian'],
    'The Prince and the Pauper.jpg': ['Prince', 'Pauper'],
    'the prince.jpg': ['the', 'prince'],
    'the raven.jpg': ['the', 'raven'],
    'The Red and The Black.jpg': ['red', 'black'],
    'The Research Magnificent.jpg': ['Research', 'Magnificent'],
    'The Sea Lady.jpg': ['Sea', 'Lady'],
    'The Secret Adversary.jpg': ['Secret', 'Adversary'],
    'The sleeper awakes.jpg': ['sleeper', 'awakes'],
    'the soul of a nation.jpg': ['soul', 'nation'],
    'The Thomas Jefferson writes.jpg': ['Thomas', 'Jefferson'],
    'The Time Machine.jpg': ['Time', 'Machine'],
    'the trial.jpg': ['the', 'trial'],
    'The Twilight of the Idols.jpg': ['Twilight', 'Idols'],
    'the voyage of the beagle.jpg': ['voyage', 'beagle'],
    'the voyage out.jpg': ['voyage', 'out'],
    'The War in the Air.jpg': ['War', 'Air'],
    'The war in the east japan.jpg': ['war', 'east', 'japan'],
    'the war of the worlds.jpg': ['war', 'worlds'],
    'The Wheels of Chance.jpg': ['Wheels', 'Chance'],
    'the whıte company.jpg': ['white', 'company'],
    'the white nights.jpg': ['white', 'nights'],
    'The wizard of wall street and his wealth.jpg': ['wizard', 'wall'],
    'The Wonderful Visit.jpg': ['Wonderful', 'Visit'],
    'The World Set Free.jpg': ['World', 'Free'],
    'the wuthering heights.jpg': ['wuthering', 'heights'],
    'the-sorrows-of-young-werther.jpg': ['sorrows', 'young', 'werther'],
    'this side of paradise.jpg': ['this', 'paradise'],
    'Three Sunsets and Other Poems.jpg': ['Three', 'Sunsets'],
    'three-essays-on-the-theory-of-sexuality.jpg': [
      'three',
      'essays',
      'sexuality'
    ],
    'thus spake zarathustra.jpg': ['spake', 'zarathustra'],
    'Tom Sawyer Abroad.jpg': ['Tom', 'Sawyer', 'Abroad'],
    'Tom Sawyer, Detective.jpg': ['Tom', 'Sawyer', 'Detective'],
    'Tono-Bungay.jpg': ['Tono', 'Bungay'],
    'totem-and-taboo.jpg': ['totem', 'taboo'],
    'turkun atesle imtihani.jpg': ['turkun', 'atesle'],
    'Twenty Thousand Leagues Under the Sea.jpg': [
      'Twenty',
      'Thousand',
      'Leagues',
    ...
    'under fire.jpg': ['under', 'fire'],
    'Under Sentence of Death.jpg': ['Under', 'Sentence', 'Death'],
    'Vicar of Wakefield.jpg': ['Vicar', 'Wakefield'],
    'vurun kahpeye.jpg': ['vurun', 'kahpeye'],
    'wanders.jpg': [
      'wanders',
    ],
    'What is Enlightenment.jpg': ['What', 'Enlightenment'],
    'white bird.jpg': ['white', 'bird'],
    'Wilhelm Meister.jpg': ['Wilhelm', 'Meister'],
    'yasadigim gibi.jpg': ['yaşadığım', 'gibi'],
    'yeni dunya.jpg': ['yeni', 'dünya'],
    'yezidin kizi.jpg': ['yezidin', 'kızı'],
    'zadig.jpg': ['zadig'],
    'A Christmas Carol.jpg': ['a', 'Christmas', 'Carol'],
    'A London Life.jpg': ['a', 'London', 'Life'],
    'A Modern Utopia.jpg': ['a', 'Modern', 'Utopia'],
    'a plug year.jpg': ['a', 'plug', 'year'],
    'america.jpg': ['america'],
    'animal farm.jpg': ['animal', 'farm'],
    'anna karenina.jpg': ['anna', 'karenina'],
    'art of war.jpg': ['art', 'war'],
    'ayesha the return of she.jpg': ['ayesha', 'return'],
    'cadi.jpg': [
      'cadı',
    ],
    'boon.jpg': ['boon'],
    'ask batagi.jpg': ['aşk', 'batağı'],
    'Anticipations.jpg': [
      'Anticipations',
    ],
    'aski memnu.jpg': ['aşkı', 'memnu'],
    'bealby.jpg': [
      'bealby',
    ],
    'kipps.jpg': [
    ...
    'Les Miserables.jpg': ['Les', 'Miserables'],
    'kirik hayatlar.jpg': ['kırık', 'hayatlar'],
    'Italian Hours.jpg': ['Italian', 'Hours'],
    'little dorrit.jpg': ['little', 'dorrit'],
    'little men.jpg': ['little', 'men'],
    'little woman.jpg': ['little', 'woman'],
    'meditations.jpg': [
      'meditations',
    ],
    'metamorphosis.jpg': [
    ...
    'pickwick club.jpg': ['pickwick', 'club'],
    'othello.jpg': ['othello'],
    'odysey.jpg': ['odysey'],
    'peter pan.jpg': ['peter', 'pan'],
    'mor salkimli ev.jpg': ['mor', 'salkımlı', 'ev'],
    'ruh adam.jpg': ['ruh', 'adam'],
    'peter pan in kensington gardens.jpg': ['peter', 'pan'],
    'sherlock holmes.jpg': ['sherlock', 'holmes'],
    'robinson crouse.jpg': ['robinson', 'crouse'],
    'aydakı kadın.jpg': ['aydaki', 'kadın'],
    'emma.jpg': [
      'emma',
    ],
    'kurk mantolu madonna.jpg': ['kürk', 'mantolu', 'madonna'],
    'Love and Mr Lewisham.jpg': ['Love', 'Lewisham'],
    'madame bovary.jpg': ['madame', 'bovary'],
    'simdi sevisme vakti.jpg': ['şimdi', 'sevişme', 'vakti'],
    // Assign tags for each image here
  };
  ...
  void _onSearchChanged() {
    // Bu fonksiyon, arama yaparken bir bekleme süresi uygular
    // ve arama sonuçlarını günceller
    Future.delayed(Duration(milliseconds: 300), () {
      setState(() {
        String value = _searchController.text.trim();
        print("Arama Değeri: $value");
        searchResults = images.where((image) {
          final tags = imageTags[image];
          print("Resim: $image, Etiketler: $tags");
          return tags != null &&
              tags.any((tag) {
                final lowercaseTag = tag.toLowerCase();
                final lowercaseValue = value.toLowerCase();
                print("Etiket: $lowercaseTag, Arama Değeri: $lowercaseValue");
                return lowercaseTag.contains(lowercaseValue);
              });
        }).toList();
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  String imageName = searchResults[index];
                  return Padding(
